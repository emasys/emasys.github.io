        ...
        function displayMoves() {
            ...
            function displayLoop() {
                setTimeout(function () {
                    ...
                    $("#" + move).addClass('light-up' + move);
                    setTimeout(function () {
                        $("#" + move).removeClass('light-up' + move);
                    }, 500);
        ...
        $(".btn")
            .on("click", function () {
                ...
                if (!gameApp.lock) {
                    ...
                    $("#" + clickedBtn).addClass('light-up' + clickedBtn);
                    setTimeout(function () {
                        $("#" + clickedBtn).removeClass('light-up' + clickedBtn);
                    }, 250);
