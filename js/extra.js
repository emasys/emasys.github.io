...
var feedback = '<div class="alert alert-success alert-dismissible fade show" role="alert"><butto' +
        'n type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria' +
        '-hidden="true">&times;</span></button><strong>Thank you!</strong> Your message h' +
        'as been sent.</div>';

var errorMsg = '<div class="alert alert-danger alert-dismissible fade show" role="alert"><button' +
        ' type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-' +
        'hidden="true">&times;</span></button><strong>Sorry, </strong>something went wron' +
        'g</div>';
